...
var $author$project$Main$initModel = F2(
	function (url, navigationKey) {
		return {navigationKey: navigationKey, title: 'Hello Navigation', url: url};
	});
...
var $author$project$Main$viewPage = function (model) {
	return A2($elm$core$String$startsWith, '/about', model.url.path) ? $mdgriffith$elm_ui$Element$text('About page') : $mdgriffith$elm_ui$Element$text('Home page');
};
