...
var $author$project$Main$initModel = F2(
	function (url, navigationKey) {
		return {modelAboutPage: $author$project$AboutPage$initModel, navigationKey: navigationKey, title: 'Hello Navigation', url: url};
	});
...
var $author$project$Main$viewPage = function (model) {
	return A2($elm$core$String$startsWith, '/about', model.url.path) ? A2(
		...
		$author$project$AboutPage$view(model.modelAboutPage)) : $author$project$HomePage$view;
};
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"MsgDummy":[],"MsgAboutPage":["AboutPage.Msg"],"MsgUrlChanged":["Url.Url"],"MsgUrlRequested":["Browser.UrlRequest"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"AboutPage.Msg":{"args":[],"tags":{"MsgShowDetailClicked":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}}}}})}});}(this));