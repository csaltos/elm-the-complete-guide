...
viewDetail showDetail =
    if showDetail then
        Element.column [ Element.spacing 10 ]
            ...
            , UI.link [ Element.Font.size 12, Element.Font.bold ] "/about/hide-detail" "Hide"
            ]

    else
        UI.linkWithAction [ Element.Font.size 12, Element.Font.bold ] MsgShowDetailClicked "Show"
